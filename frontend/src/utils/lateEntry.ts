...
export function lateJoinMessage(
  ...
  if (roundInProgress) {
    return `Round ${currentRound} is already under way. Rounds you missed count as losses. If someone is currently sitting out you'll be paired with them; otherwise you sit out round ${currentRound} as a loss too, because joining late never earns you a free win. You're in the draw properly from round ${currentRound + 1}.`;
  }
