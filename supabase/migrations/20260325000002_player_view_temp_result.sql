-- Expose temp_result and temp_winner_id in get_player_tournament_view so
-- the player pairings table can show organiser pre-filled results in real-time,
-- mirroring what the organiser's pairings page displays.
