-- ============================================================
-- Player view knows its game (2026-09-01) — 1.0 Phase D
--
-- get_player_tournament_view drives the player-facing standings.
-- Without the game id the page fell back to Play! Pokémon
-- tiebreakers, so a generic event showed players a different
-- ranking from the one the organiser's screens showed.
--
-- Reproduced from the live definition with two additions: game_id
-- is selected into v_tournament, and returned in the tournament
-- object. Nothing else is changed.
-- ============================================================
